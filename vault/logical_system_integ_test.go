...
func testPlugin_CatalogRemoved(t *testing.T, btype logical.BackendType, testMount bool) {
	...
	req := logical.TestRequest(t, logical.DeleteOperation, "sys/plugins/catalog/database/test")
	req.ClientToken = core.Client.Token()
	resp, err := core.HandleRequest(namespace.RootContext(nil), req)
...
func testPlugin_continueOnError(t *testing.T, btype logical.BackendType, mismatch bool) {
	...
	req := logical.TestRequest(t, logical.ReadOperation, "sys/plugins/catalog/database/test")
	req.ClientToken = core.Client.Token()
	resp, err := core.HandleRequest(namespace.RootContext(nil), req)
	...
	if mismatch {
		req = logical.TestRequest(t, logical.UpdateOperation, "sys/plugins/catalog/database/test")
