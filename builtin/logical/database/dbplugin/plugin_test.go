...
func TestPlugin_Init(t *testing.T) {
	...
	dbRaw, err := dbplugin.PluginFactory(namespace.TestContext(), "test-plugin", consts.PluginTypeDatabase, sys, log.NewNullLogger())
	if err != nil {
		t.Fatalf("err: %s", err)
	}
...
func TestPlugin_CreateUser(t *testing.T) {
	...
	db, err := dbplugin.PluginFactory(namespace.TestContext(), "test-plugin", consts.PluginTypeDatabase, sys, log.NewNullLogger())
	if err != nil {
		t.Fatalf("err: %s", err)
	}
	defer db.Close()
...
func TestPlugin_NetRPC_Init(t *testing.T) {
	...
	dbRaw, err := dbplugin.PluginFactory(namespace.TestContext(), "test-plugin-netRPC", consts.PluginTypeDatabase, sys, log.NewNullLogger())
	if err != nil {
		t.Fatalf("err: %s", err)
	}
...
func TestPlugin_NetRPC_CreateUser(t *testing.T) {
	...
	db, err := dbplugin.PluginFactory(namespace.TestContext(), "test-plugin-netRPC", consts.PluginTypeDatabase, sys, log.NewNullLogger())
	if err != nil {
		t.Fatalf("err: %s", err)
	}
	defer db.Close()
