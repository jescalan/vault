...
**_Vault Enterprise_** integrates with [HSM platforms](/docs/enterprise/hsm/index.html)
...
In another terminal, set the `VAULT_ADDR` environment variable, and [initialize](/intro/getting-started/deploy.html#initializing-the-vault) your Vault server.
